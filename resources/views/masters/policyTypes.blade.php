...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('ADD NEW POLICY TYPE') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('masters.store', ['option' => $option]) }}">
                        ...
                        <div class="form-group row">
                            <label for="policyType_name" class="col-md-4 col-form-label text-md-right">{{ __('Policy Type') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">{{ __('Add Policy Type') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
